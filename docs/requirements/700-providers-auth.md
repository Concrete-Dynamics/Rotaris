...
Derived requirements: [SWR-776 — Provider subscription-usage reads for quota display](700-providers-auth/SWR-776-subscription-usage-reads.md), [SWR-781 — Standard Keycloak OIDC authorization-code authentication](700-providers-auth/SWR-781-standard-keycloak-oidc.md)
